...
public class EpisodesByOriginalPublishDateInDescendingOrderTest extends BaseTest {
    ...
    String seriesTitle;
    Boolean seriesHasSeasonOrderedByPublishDateDescending = false;
    List<String> episodesTitles;
    Integer seasonNumber;

    @Factory(dataProvider = StaticProps.DEFAULT_DATA_PROVIDER, dataProviderClass = DataProviderManager.class)
    public EpisodesByOriginalPublishDateInDescendingOrderTest(String runParams) {
    ...
    public void setupTest() {
        ...
        for (String seriesID : seriesIDs) {
            ...
            seriesHasSeasonOrderedByPublishDateDescending = appDataFeed.hasSeasonOrderedByPublishDateDescending(seriesURL);
            if (seriesHasSeasonOrderedByPublishDateDescending) {
                Long seasonNumberLong = appDataFeed.getSeasonOrderedByPublishDateDescendingNumber(seriesURL);
                episodesTitles = appDataFeed.getSortedEpisodeTitlesByOriginalPublishDateInDescendingOrder(seriesURL, seasonNumberLong);
    ...
    public void episodesByOriginalPublishDateInDescendingOrderAndroidTest() {
        ...
        if (seriesHasSeasonOrderedByPublishDateDescending) {
            ...
            String message = "There's no series with episodes ordered by original publish date and in descending order on " +
    ...
    public void episodesByOriginalPublishDateInDescendingOrderiOSTest() {
