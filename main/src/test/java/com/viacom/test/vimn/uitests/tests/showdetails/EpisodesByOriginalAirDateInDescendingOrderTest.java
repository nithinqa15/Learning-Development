...
public class EpisodesByOriginalAirDateInDescendingOrderTest extends BaseTest {
    ...
    String seriesTitle;
    Boolean seriesHasSeasonOrderedByOriginalAirDateDescending = false;
    List<String> episodesTitles;
    Integer seasonNumber;

    @Factory(dataProvider = StaticProps.DEFAULT_DATA_PROVIDER, dataProviderClass = DataProviderManager.class)
    public EpisodesByOriginalAirDateInDescendingOrderTest(String runParams) {
    ...
    public void setupTest() {
        ...
        for (String seriesID : seriesIDs) {
            ...
            seriesHasSeasonOrderedByOriginalAirDateDescending = appDataFeed.hasSeasonOrderedByOriginalAirDateDescending(seriesURL);
            if (seriesHasSeasonOrderedByOriginalAirDateDescending) {
                Long seasonNumberLong = appDataFeed.getSeasonOrderedByOriginalAirDateDescendingNumber(seriesURL);
                episodesTitles = appDataFeed.getSortedEpisodeTitlesByOriginalAirDateInDescendingOrder(seriesURL, seasonNumberLong);
    ...
    public void episodesByOriginalAirDateInDescendingOrderAndroidTest() {
        ...
        if (seriesHasSeasonOrderedByOriginalAirDateDescending) {
            ...
            String message = "There's no series with episodes ordered by original air date and in descending order on " +
    ...
    public void episodesByOriginalAirDateInDescendingOrderiOSTest() {
