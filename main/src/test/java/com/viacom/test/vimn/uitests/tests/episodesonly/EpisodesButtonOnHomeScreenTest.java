...
public class EpisodesButtonOnHomeScreenTest extends BaseTest {
	...
	public EpisodesButtonOnHomeScreenTest(String runParams) {
	...
	public void episodesButtonOnHomeScreenAndroidTest() {
	...
	public void episodesButtonOnHomeScreeniOSTest() {
