...
public class MoviesContentPlaybackAutoplayONTest extends BaseTest {
    ...
    public MoviesContentPlaybackAutoplayONTest(String runParams) {
    ...
    public void moviesContentPlaybackAutoplayONAndroidTest() {
        ...
        if (firstMovieTitle != null && !hasTrailerOnly) {
            ...
            home.enterSeriesView(firstMovieTitle, numberOfSwips);
    ...
    public void moviesContentPlaybackAutoplayONiOSTest() {
