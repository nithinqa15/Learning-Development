...
public class ClipsContinuousPlaybackWithAutoplayClipsOn extends BaseTest {
	...
	public ClipsContinuousPlaybackWithAutoplayClipsOn(String runParams) {
	...
	public void setUpTest() {
		...
		if (shortFormEnabled) {
			...
			clipTitle1 = seriesResult.getClips().getFirstClip().getClipTitle();
			clipTitle2 = seriesResult.getClips().get(1).getClipTitle();
		}
	}
	...
	public void clipsContinuousPlaybackWithAutoplayClipsOnAndroidTest() {
		if (shortFormEnabled && seriesTitle != null) {
			...
			clips.clipTitle(clipTitle1).waitForVisible();
			videoPlayer.progressSpinner().waitForPlayerLoad();
			videoPlayer.verifyVideoIsPlayingByScreenshots(5);
			videoPlayer.getToEndOfVideo();
			clips.clipTitle(clipTitle2).waitForVisible();
			videoPlayer.progressSpinner().waitForPlayerLoad();
			videoPlayer.verifyVideoIsPlayingByScreenshots(5);
	...
	public void clipsContinuousPlaybackWithAutoplayClipsOniOSTest() {
