...
public class EpisodesByOriginalPublishDateInAscendingOrderTest extends BaseTest {
    ...
    String seriesTitle;
    Boolean seriesHasSeasonOrderedByPublishDateAscending = false;
    List<String> episodesTitles;
    Integer seasonNumber;

    @Factory(dataProvider = StaticProps.DEFAULT_DATA_PROVIDER, dataProviderClass = DataProviderManager.class)
    public EpisodesByOriginalPublishDateInAscendingOrderTest(String runParams) {
    ...
    public void setupTest() {
        ...
        for (String seriesID : seriesIDs) {
            ...
            seriesHasSeasonOrderedByPublishDateAscending = appDataFeed.hasSeasonOrderedByPublishDateAscending(seriesURL);
            if (seriesHasSeasonOrderedByPublishDateAscending) {
                Long seasonNumberLong = appDataFeed.getSeasonOrderedByPublishDateAscendingNumber(seriesURL);
                episodesTitles = appDataFeed.getSortedEpisodeTitlesByOriginalPublishDateInAscendingOrder(seriesURL, seasonNumberLong);
    ...
    public void episodesByOriginalPublishDateInAscendingOrderAndroidTest() {
        ...
        if (seriesHasSeasonOrderedByPublishDateAscending) {
            ...
            String message = "There's no series with episodes ordered by original publish date and in ascending order on " +
    ...
    public void episodesByOriginalPublishDateInAscendingOrderiOSTest() {
