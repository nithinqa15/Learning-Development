...
public class SingleBinaryCCMTVSEATest extends BaseTest {
	...
	public SingleBinaryCCMTVSEATest(String runParams) {
	...
	public void setupTest() {
		...
		expectedProviderList = singleBinary.expectedSEAProviderList(TestRun.getLocale());

	}

	@TestCaseId("44038-44044")
	@Features(GroupProps.SINGLE_BINARY)
	@Test(groups = { GroupProps.BROKEN, GroupProps.SINGLE_BINARY })
	@Parameters({ ParamProps.ANDROID, ParamProps.MTV_INTL_APP, ParamProps.CC_INTL_APP })
	public void singleBinaryCCMTVSEAAndroidTest() {
	...
	public void singleBinaryCCMTVSEAiOSTest() {
