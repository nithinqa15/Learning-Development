...
public class EpisodesByOriginalAirDateInAscendingOrderTest extends BaseTest {
    ...
    String seriesTitle;
    Boolean seriesHasSeasonOrderedByOriginalAirDateAscending = false;
    List<String> episodesTitles;
    Integer seasonNumber;

    @Factory(dataProvider = StaticProps.DEFAULT_DATA_PROVIDER, dataProviderClass = DataProviderManager.class)
    public EpisodesByOriginalAirDateInAscendingOrderTest(String runParams) {
    ...
    public void setupTest() {
        ...
        for (String seriesID : seriesIDs) {
            ...
            seriesHasSeasonOrderedByOriginalAirDateAscending = appDataFeed.hasSeasonOrderedByOriginalAirDateAscending(seriesURL);
            if (seriesHasSeasonOrderedByOriginalAirDateAscending) {
                Long seasonNumberLong = appDataFeed.getSeasonOrderedByOriginalAirDateAscendingNumber(seriesURL);
                episodesTitles = appDataFeed.getSortedEpisodeTitlesByOriginalAirDateInAscendingOrder(seriesURL, seasonNumberLong);
    ...
    public void episodesByOriginalAirDateInAscendingOrderAndroidTest() {
        ...
        if (seriesHasSeasonOrderedByOriginalAirDateAscending) {
            ...
            String message = "There's no series with episodes ordered by original air date and in ascending order on " +
    ...
    public void episodesByOriginalAirDateInAscendingOrderiOSTest() {
