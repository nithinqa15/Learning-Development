...
public class MoviesContentPlaybackAutoplayOFFTest extends BaseTest {
    ...
    public MoviesContentPlaybackAutoplayOFFTest(String runParams) {
    ...
    public void setupTest() {
        ...
        numberOfSwipes = firstMovie.getNumOfSwipes();
    ...
    public void moviesContentPlaybackAutoplayOFFAndroidTest() {
        ...
        if (firstMovieTitle != null && !hasTrailerOnly) {
            ...
            home.enterSeriesView(firstMovieTitle, numberOfSwipes);
    ...
    public void moviesContentPlaybackAutoplayOFFiOSTest() {
    	...
    	if (firstMovieTitle != null && !hasTrailerOnly) {
            ...
            home.flickRightToSeriesThumb(firstMovieTitle, numberOfSwipes);
