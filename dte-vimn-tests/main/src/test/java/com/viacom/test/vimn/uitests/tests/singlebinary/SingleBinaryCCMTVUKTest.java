...
public class SingleBinaryCCMTVUKTest extends BaseTest {
	...
	public SingleBinaryCCMTVUKTest(String runParams) {
	...
	public void setupTest() {
		...
		expectedProviderList = singleBinary.expectedMTVCCUKProviderList(TestRun.getLocale());

	}

	@TestCaseId("44043-44050")
	...
	public void singleBinaryCCMTVUKAndroidTest() {
	...
	@TestCaseId("44043-44050")
	@Features(GroupProps.SINGLE_BINARY)
	@Test(groups = { GroupProps.BROKEN, GroupProps.SINGLE_BINARY }) // set to broken since TVE not implemented yet
	@Parameters({ ParamProps.IOS, ParamProps.MTV_INTL_APP, ParamProps.CC_INTL_APP })
	public void singleBinaryCCMTVUKiOSTest() {
