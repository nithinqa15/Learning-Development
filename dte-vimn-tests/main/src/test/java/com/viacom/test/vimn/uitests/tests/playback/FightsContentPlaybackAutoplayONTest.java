...
public class FightsContentPlaybackAutoplayONTest extends BaseTest {
    ...
    public FightsContentPlaybackAutoplayONTest(String runParams) {
    ...
    public void fightsContentPlaybackAutoplayONAndroidTest() {
    ...
    public void fightsContentPlaybackAutoplayONiOSTest() {
