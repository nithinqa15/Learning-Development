...
public class MegabeaconFeStartTest extends BaseTest {
    ...
    public MegabeaconFeStartTest(String runParams) {
    ...
    public void megabeaconFeStartPlayerCallAndroidTest() {
        ...
        expectedMap = MegabeaconPlayerData.buildFepStartPlayerExpectedMap(seriesTitle, episodeMgid, segmentMgid, numberOfSegments, segmentTitle, contentType, playlistTitle);
    ...
    @Parameters({ Config.ParamProps.IOS, Config.ParamProps.TVLAND_APP, Config.ParamProps.CC_INTL_APP, Config.ParamProps.CC_DOMESTIC_APP,
            Config.ParamProps.MTV_INTL_APP, Config.ParamProps.MTV_DOMESTIC_APP, Config.ParamProps.CMT_APP,
            Config.ParamProps.VH1_APP, Config.ParamProps.PARAMOUNT_APP, Config.ParamProps.BET_DOMESTIC_APP })
    public void megabeaconFeStartPlayerCalliOSTest() {
        splashChain.splashAtRest();
        chromecastChain.dismissChromecast();
        autoPlayChain.enableAutoPlay();
        ProxyUtils.disableTve();
